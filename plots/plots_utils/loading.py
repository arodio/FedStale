...
class ExperimentConfig:
    def __init__(self, base_path, experiment, seeds, algorithms, events, lr_list,
                 ...
                 biased_list, train_test, batch_sizes=None):
        """
    ...
    def get_event_dir(self, algo, lr, seed, event, alpha, n_clients, availability, n_rounds, participation, biased, train_test, batch_size=None):
        """
