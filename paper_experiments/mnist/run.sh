    ...
    for lr in $lrs; do
        for seed in $seeds; do
            ...
            python train.py \
                ...
                --logs_dir logs/mnist/p_${participation}/h_${heterogeneity}/fedvarp/lr_${lr}/seed_${seed} \
                --seed ${seed} \
                --verbose 0
        done
    done
    ...
    for lr in $lrs; do
        for seed in $seeds; do
            ...
            python train.py \
                ...
                --swap_labels \
                --swap_proportion ${heterogeneity} \
                --logs_dir logs/mnist/p_${participation}/h_${heterogeneity}/fedavg/lr_${lr}/seed_${seed} \
                --seed ${seed} \
                --verbose 0
        done
    done
        ...
        for weight in $weights; do
            for seed in $seeds ; do
              ...
              python train.py \
                  ...
                  --swap_labels \
                  --swap_proportion ${heterogeneity} \
                  --logs_dir logs/mnist/p_${participation}/h_${heterogeneity}/fedstale/b_${weight}/lr_${lr}/seed_${seed} \
                  --seed ${seed} \
                  --verbose 0
            done
        done
